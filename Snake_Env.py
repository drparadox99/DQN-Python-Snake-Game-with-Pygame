...
class SnakeEnv():
    def __init__(self):
        ...
        pygame.init()
        pygame.display.set_caption('DQN (RL) Snake Game')
        self.display = pygame.display.set_mode((WIDTH, HEIGHT))
        self.clock = pygame.time.Clock()
        self.font = pygame.font.SysFont('Arial_bold', 380)

        self.snake_dir = '' #initial value set in reset()
    ...
    def render(self, render_mode='human'):
        ...
        # score
        if self.snake_dead:
            img = self.font.render(str(self.score), True, (128,0,128))
        else:
            img = self.font.render(str(self.score), True, (172,203,255))
        ...
        for part in self.snake_list[1:]:
            pygame.draw.rect(self.display, (38,204,0), (part[0] * 15 + 1, part[1] * 15 + 1, 13, 13))
        # snake head
        pygame.draw.rect(self.display, (0,156,26),
